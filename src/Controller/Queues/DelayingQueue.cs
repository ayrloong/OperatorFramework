using Kubernetes.Controller.Queues.Utils;
using Microsoft.Extensions.Internal;

namespace Kubernetes.Controller.Queues;
...
public class DelayingQueue<TItem> : Composition.WorkQueueBase<TItem>, IDelayingQueue<TItem>
{
    ...
    private struct WaitFor
    {
        ...
        public static int Compare(WaitFor first, WaitFor second) =>
            DateTimeOffset.Compare(first.ReadyAt, second.ReadyAt);
    }
}