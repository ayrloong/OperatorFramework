...
#pragma warning restore CA2213 // Disposable fields should be disposed        
        ...
        ILogger logger)
    {
        ...
        _hostApplicationStoppingRegistration =
            _hostApplicationLifetime.ApplicationStopping.Register(_runCancellation.Cancel);
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        async Task CallRunAsync()
        {
            ...
            {
                if (_hostApplicationLifetime.ApplicationStopping.IsCancellationRequested) throw;
