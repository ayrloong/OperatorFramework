...
public class OpenApiResourceKindElement : IResourceKindElement
{
    ...
    private IResourceKindElement BindCollectionElementType()
    {
        return MergeStrategy switch
        {
            ...
            // dictionary strategy
            ElementMergeStrategy.MergeMap => _resourceKind.BindElement(_jsonSchema.AdditionalPropertiesSchema
                .ActualSchema),
            ...
            _ => throw new InvalidOperationException(
                $"Merge strategy '${MergeStrategy}' does not support GetCollectionElementType.")
        };
    }
}